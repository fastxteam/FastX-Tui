...
class UpdateManager:
    ...
    def check_version_update(self, force_check: bool = False) -> tuple[bool, str | None]:
        """检查GitHub上的版本更新
    ...
    def get_update_message(self) -> str:
        ...
        message += "查看最新版本: https://github.com/fastxteam/FastX-Tui/releases/latest"
    ...
    def _update_from_exe(self) -> bool:
        ...
        try:
            ...
            # 下载新版本到当前目录
            new_exe_path = os.path.join(current_exe_dir, "fastx-tui_new.exe")
            ...
            # 创建批处理脚本用于更新
            batch_script_path = os.path.join(current_exe_dir, "fastx-tui_update.bat")
...
'''
    ...
    def _get_exe_download_url(self) -> str | None:
        """获取可执行文件的下载URL
