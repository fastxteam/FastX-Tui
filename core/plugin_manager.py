...
class PluginManager:
    ...
    def load_plugin(self, plugin_name: str) -> Plugin | None:
        """加载单个插件"""
        try:
            # 确定插件类型和入口文件路径
...
class PluginRepository:
    ...
    def get_plugin_info_from_github(self, repo_url: str) -> dict[str, Any] | None:
    ...
    def get_plugin_details(self, plugin_id: str) -> dict[str, Any] | None:
        """获取插件详情"""
        try:
            import requests
